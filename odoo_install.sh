...
sudo git clone --branch $OE_VERSION https://github.com/OCA/OCB.git $OE_HOME_EXT/

echo -e "\n---- Create custom module directory ----"
sudo su $OE_USER -c "mkdir $OE_HOME/custom"
sudo su $OE_USER -c "mkdir $OE_HOME/custom/addons"
sudo su $OE_USER -c "mkdir $OE_HOME_EXT/OCA"
...
sudo su root -c "echo 'addons_path = $OE_HOME_EXT/OCA_addons,$OE_HOME_EXT/addons,$OE_HOME/custom/addons' >> /etc/$OE_CONFIG.conf"
